...
<div class="row" style="padding-bottom: 2px; height: 100%;">
	<div class="col-md-2" style="padding-left: 1%">
		...
		<h4 style1="text-align: center;"> &nbsp; Карта электросетей
			<span style="float: right;cursor: pointer;" class="glyphicon glyphicon-erase" title="Очистить карту"></span>
		</h4>
		<select id="bel_energo_companies2" class="form-control input-sm" style="margin: 1px;">
			<option value="bel_energo_companies2"> - ЭС -</option>
		</select>
		<h5></h5>
		<select id="sectors" class="form-control input-sm" style="margin: 1px;">
			<option value=""> - УЧАСТКИ -</option>
			<% DatabaseServiceImpl hW = new DatabaseServiceImpl();
			   for (BelEnergoCompany company : hW.getAllBelEnergoCompanies()){%>
		...
		<div class="panel">
			...
			<div class="panel-body checkbox" id="bel_energo_companies2"></div>
		</div>
		<h5></h5>
		<div class="panel">
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?sensor=false&libraries=visualization&dummy=.js"></script>
